...
<!-- HEADER.PHP -->
    ...
    <body id="top">
            ...
            <div id="topbar" class="hoc clear">
                ...
                <ul>
                    ...
                    ?>
                            ...
                            ?>
                                <li><a href="pages/ajustes.php" title="Ajusteak" id="btnSettings"><i class="fa fa-lg fa-cog"></i></a> </li>
        ...
        <div class='bgded overlay' style="background-image:url('images/demo/backgrounds/fondoIndex.jpg');">
            ...
            <!-- ################################################################################################ -->
            <!-- ################################################################################################ -->
            <div id="userTable" class="hoc clear">
                    ...
                    <tr>
                        ...
                        <!-- <form method="post" action="<?php echo $_SERVER['PHP_SELF']?>"> -->
                            ...
                            ?>
                                    ...
                                    <td> <input class="inputSetting" type="text" id="erabiltzailea" name="erabiltzailea" value="<?php echo $erabiltzaile_iz ?>" readonly></td>
                                    <td> <input class="inputSetting" type="text" id="izena" name="izena" value="<?php echo $izena ?>" readonly></td>
                                    <td> <input class="inputSetting" type="text" id="abizena" name="abizena" value="<?php echo $abizena ?>" readonly></td>
                                    <td> <input class="inputSetting" type="text" id="email"  name="email" value="<?php echo $email ?>" readonly></td>
                                    <td> <input class="inputSetting" type="text" id="password" name="password" value="*********" readonly></td>
                                    <td> <input class="inputSetting" type="text" id="adminRol" name="adminRol" value="<?php echo $adminRol ?>" readonly></td>
                                    <td>
