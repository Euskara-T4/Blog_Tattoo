        ...
        <div id="topbar" class="hoc clear">
            ...
            <ul>
                ...
                <?php
                        ...
                        ?>
                <li><a href="pages/ajustes.php" title="Ajusteak" id="btnSettings"><i class="fa fa-lg fa-cog"></i></a>
                </li>
                ...
                <tr>
                    ...
                    <!-- <form method="post" action="<?php echo $_SERVER['PHP_SELF']?>"> -->
                        ...
                        ?>
                            ...
                            <td> <input class="inputSetting" type="text" name="erabiltzailea" value="<?php echo $erabiltzaile_iz ?>" readonly></td>
                            <td> <input class="inputSetting" type="text" name="izena" value="<?php echo $izena ?>" readonly></td>
                            <td> <input class="inputSetting" type="text" name="abizena" value="<?php echo $abizena ?>" readonly></td>
                            <td> <input class="inputSetting" id="emailSet" type="text" name="email" value="<?php echo $email ?>" readonly></td>
                            <td> <input class="inputSetting" type="text" name="password" value="*********" readonly></td>
                            <td> <input class="inputSetting" id="adminSet" type="text" name="adminRol" value="<?php echo $adminRol ?>" readonly></td>
                            <td>
